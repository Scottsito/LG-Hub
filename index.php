<h11 id = "please">Please visit Gxme Hub at the official site (view links in <a href="https://discord.gg/9U8tHAQT43" target="_blank">the disxvord</a>) to play</h11>

<!-- go to https://fzhoolknwz-2.unknowncicada.repl.co, password is eased - from legends -->
<!-- Arya was here -->
<!-- Dank Memer was here C: -->
<div id = "content">
<!DOCTYPE html>
<html>
  <head>
...
<meta name="author" content="legends#7965">
<meta name='dmca-site-verification' content='a2hOeVZ4bDkzM3VsNWU0S1ZhMldwYWVmbmhLSHM3RE1jUzV5MndoanpIMD01' />

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-7X6S1D9HT1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-7X6S1D9HT1');
</script>



<div style="background-color: #2e2e2e; height:30px; border:thin solid #2e2e2e">
    </ul> 
        <li style='padding-top:5px;padding-left:100px;text-align:center;font-family:Verdana'>Announcement: WEBSITE HAS BEEN RELEASED, PLEASE SHARE THIS WEBSITE TO EVERYONE!</li> 
    </ul> 
</div>
    <link rel = "stylesheet" href="./style.css"/>
    <title>Gxme Hub</title>
  </head>
  <body>
    <div class="topnav">
      ...
      |
      <a href="gxmes/index.html">Gxmes</a>
      |
      <a href="emulators/index.html">Emulators</a>
      |
      <a href="mc/index.html">MC 1.5.2</a>
      |
      <a href="pxy/index.html">Pr*xies</a>
      |
      <a href="settings/index.html">Settings</a>
      |
      <a href="https://www.google.com">PANIC!</a>
      |
      <a href="partners/index.html">Partners</a>

    </div>  
    <img src = "./logo.gif"/>
    <h4 class = "a">Welcome to the HTML5 & CSS version of Gxme Hub!</h4>
